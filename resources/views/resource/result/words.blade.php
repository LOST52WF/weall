    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 col-md-offset-7">
                      <form action="/resource/result/words" method="get" target="_blank">
...
<!--------------------------------------二级导航栏结束------------------------------------------->
                <div class="row" style="margin-top: 25px;margin-left: 80px;">
                    ...
                    @if($info['cur']!=0)
                        @foreach($data as $v)
                        <a href="/share/words/{{$v->resource_id}}" style="color:#333;">
...
<!--------------------------------------------页码开始-------------------------------------------------->
                ...
                <!----------上一页设置---------->
                        ...
                        @else
                        <li>
                            <a href="/resource/result/words?searchcon={{$arr['searchcon']}}&order={{$arr['order']}}&page={{$info['cur']-1}}" aria-label="Previous">
                            上一页
                            </a>
                        </li>
                        @endif
                <!----------中间页设置---------->
                        @if($info['cur'] <= 4)
                            @for($i=1;$i<=7;$i++)
                                ...
                                <li>
                                    <a href="/resource/result/words?searchcon={{$arr['searchcon']}}&order={{$arr['order']}}&page={{$i}}" style="color:red">
                                        <b>{{$i}}</b>
                                    </a>
                                </li>
                                @elseif($i!=$info['cur']&&$i<=$info['pagecount'])
                                <li>
                                    <a href="/resource/result/words?searchcon={{$arr['searchcon']}}&order={{$arr['order']}}&page={{$i}}">
                                        {{$i}}
                                    </a>
                                </li>
                                @endif
                                @if($i>$info['pagecount'])
                                <li class="disabled">
                                    <a disabled="ture" href="/resource/result/words?searchcon={{$arr['searchcon']}}&order={{$arr['order']}}&page={{$i}}" style="pointer-events:none;cursor:not-allowed;">
                                        {{$i}}
                                    </a>
                                </li>
                                @endif
