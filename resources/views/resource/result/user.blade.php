                ...
                <div class="row">
                    ...
                    <div class="xq_bag" id="bar3" style="margin-top: 17px; margin-right:0px;margin-left:67px;margin-bottom:0px;">
                        <ul class="xq_navbar">
                            ...
                            <li class="xq_navli">
                                <a href="/resource/result/user?searchcon={{$arr['searchcon']}}&order=upload_time&page=1" style="color:#333">用户
                                </a>
                            </li>
                        </ul>
                    </div>
...
<!--------------------------------------二级导航栏结束------------------------------------------->
                <div class="row" style="margin-top: 25px;margin-left: 80px;">
                    <div class="col-md-10 col-md-offset-1">
                        @foreach($data as $v)
                        <a href="/share/video/{{$v->resource_id}}" style="color:#333;">
...
<!--------------------------------------------页码开始-------------------------------------------------->
                ...
                <!----------上一页设置---------->
                        ...
                        @else
                        <li>
                            <a href="/resource/result/video?searchcon={{$arr['searchcon']}}&order={{$arr['order']}}&page={{$info['cur']-1}}" aria-label="Previous">
                            上一页
                            </a>
                        </li>
                        @endif
                <!----------中间页设置---------->
                        @if($info['cur'] <= 4)
                            @for($i=1;$i<=7;$i++)
                                ...
                                <li>
                                    <a href="/resource/result/video?searchcon={{$arr['searchcon']}}&order={{$arr['order']}}&page={{$i}}" style="color:red">
                                        <b>{{$i}}</b>
                                    </a>
                                </li>
                                @elseif($i!=$info['cur']&&$i<=$info['pagecount'])
                                <li>
                                    <a href="/resource/result/video?searchcon={{$arr['searchcon']}}&order={{$arr['order']}}&page={{$i}}">
                                        {{$i}}
                                    </a>
                                </li>
                                @endif
                                @if($i>$info['pagecount'])
                                <li class="disabled">
                                    <a disabled="ture" href="/resource/result/video?searchcon={{$arr['searchcon']}}&order={{$arr['order']}}&page={{$i}}" style="pointer-events:none;cursor:not-allowed;">
                                        {{$i}}
                                    </a>
                                </li>
                                @endif
