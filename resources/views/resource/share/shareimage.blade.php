            ...
            <div class="row animated fadeInUp">
                <div class="row">
                    <div class="col-md-9 col-md-offset-1"> 
                        <div class="panel panel-default" style="margin-top: 20px; margin-left: 60px;">
                            <div class="panel-body" style="padding-bottom: 0px;">
                                    <a href="/share/imageplayer/{{$data->resource_id}}">
                                        <img class="data-img" src="{{$data->picture_url}}" style="width: 960px;" />
                                    </a>
                                </div>
                            </div>
                            <div class="panel-footer" style="margin-left: 50px;width: 960px;padding-bottom: 0px;height: 166px;">
                                ...
                                @endif
                                    ...
                                    <div class="row" style="margin-top: 0PX;">
                                        <div id="starttwo" class="block clearfix" style=" padding-left: 0px;">
                                            <div  class="star_score" onclick="submit_score('{{$data->resource_id}}')"></div>
                                            <p style="float:left;padding-left:0px;margin-top:5px;margin-bottom: 0px;">您的评分：<span class="fenshu">{{$sc['score']}}</span> 分</p>
                                            <p style="padding-left:0px;margin-top:5px;margin-bottom: 0px;" id="scoredd">
...
<!--------------------------------------------评论区---------------------------------------------->
    <div class="row">
        <div class=" col-md-9 col-md-offset-1">
            <div class="panel panel-default" style="margin-left:50px;width: 960px;">
                ...
                <div class="panel-body">
                    <div class="row" style="margin-top:0px;" >
                        ...
                        <div class="col-md-8" style="padding-left: 0px;">
                            <textarea name="textareaname" id="user_comment" rows="3" cols="5" style="height: 75px; width: 600px; margin: 0px;resize:none;border-bottom-right-radius: 5px;border-top-right-radius: 5px;"></textarea>
                        </div>
                        <div class="col-md-2">
