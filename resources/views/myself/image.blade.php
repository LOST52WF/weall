                        ...
                        <div class="col-sm-4 col-md-3">
                            <div class="thumbnail" >
                                ...
                                <div class="caption">
                                    ...
                                    <p><a href="/myself/player/image/{{$v->id}}" class="btn btn-primary" target="_blank" role="button">查看</a> <a href="#" class="btn btn-default" role="button">删除</a></p>
                                </div>
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="col-sm-4 col-md-3">
                            <div class="thumbnail"  style="visibility:hidden;">
                                ...
                                <div class="caption">
                                    ...
                                    <p>点击次数：NULL次</p>
                                    <p>上传时间：NULL</p>
                                    <p><a href="#" class="btn btn-primary" target="_blank" role="button">查看</a> <a href="#" class="btn btn-default" role="button">删除</a></p>
                                </div>
                            </div>
                        </div>
                        @endfor
