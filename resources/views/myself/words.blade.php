                        ...
                        <div class="col-sm-4 col-md-3">
                            <div class="thumbnail" >
                                ...
                                <div class="caption">
                                    ...
                                    <p><a href="/myself/player/words/{{$v->id}}" class="btn btn-primary" target="_blank" role="button">下载</a> <a href="#" class="btn btn-default" role="button">删除</a></p>
                                </div>
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="col-sm-4 col-md-3">
                            <div class="thumbnail"  style="visibility:hidden;">
                                ...
                                <div class="caption">
                                    ...
                                    <p>点击次数：NULL次</p>
                                    <p>上传时间：NULL</p>
                                    <p><a href="#" class="btn btn-primary" target="_blank" role="button">阅读</a> <a href="#" class="btn btn-default" role="button">删除</a></p>
                                </div>
                            </div>
                        </div>
                        @endfor
...
<!---------------------------------------页码----------------------------------------------->
                ...
                <!----------上一页设置---------->
                        ...
                        @else
                        <li>
                            <a href="/myself/words/{{$current-1}}" aria-label="Previous">
                            上一页
                            </a>
                        </li>
                        @endif
                <!----------中间页设置---------->
                        @if($current <= 4)
                            @for($i=1;$i<=7;$i++)
                                @if($i==$current&&$i<=$page)
                                <li><a href="/myself/words/{{$i}}" style="color:red"><b>{{$i}}</b></a></li>
                                @elseif($i!=$current&&$i<=$page)
                                <li><a href="/myself/words/{{$i}}">{{$i}}</a></li>
                                @endif
                                @if($i>$page)
                                <li class="disabled"><a disabled="ture" href="/myself/words/{{$i}}" style="pointer-events:none;cursor:not-allowed;">{{$i}}</a></li>
                                @endif
                            @endfor
                        @elseif($current > 4)
