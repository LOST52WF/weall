...
<!-------------------------------------------主体部分--------------------------------------------->
        <div class="content" style="background-color: white">
            <div class="row animated fadeInUp" style="height: 493px;">
                    ...
                    <div class="col-md-9 col-md-offset-1"> 
                        <div class="panel panel-default" style="margin-top: 20px; margin-left: 45px;">
                            <div class="panel-body" style="padding-bottom: 0px;">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <img src="/static/img/book.png" style="height: 100px;"> 
                                    </div>
                                    <div class="col-md-8">
                                         <span class="input-group-addon" style=" background-color:white;height: 94px;border:0px;"><a href="/player/download/words/{{$data->id}}" target="_blank">点击下载</a></span>
                                    </div>
                                </div>
                            </div>
