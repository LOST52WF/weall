                ...
                <div class="row" style="margin-top: 40px;">
                    <div class="col-md-9 col-md-offset-1"> 
                        <div class="panel panel-default" style="margin-top: 20px; margin-left: 45px;">
                            <div class="panel-heading" style="margin-left: 15px;width: 960px;"><h4 style="margin: 0px;">文档审查</h4></div>
                            <div class="panel-body" style="padding-bottom: 0px;">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3" style="padding: 0px;padding-bottom:0px;">
                                        <p style="visibility:hidden;font-size: 20px;margin-bottom: 0px;">NULL</p>
                                        <a href="/admin/check/wordsview/{{$data->id}}">
                                    ...
                                    <div class="col-sm-3" style="padding: 0px;padding-bottom:0px;">
                                        <p style="visibility:hidden;font-size: 20px;margin-bottom: 0px;">NULL</p>
                                        <a href="/share/download/words/{{$data->id}}" target="_blank">
                            ...
                            <div class="panel-footer" style="margin-left: 15px;width: 960px;height: 310px;">
