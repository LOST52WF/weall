            ...
            <div class="row animated fadeInUp" style="background-color: white"  onsubmit="return gettag()">
                <div class="row" style="margin-top: 20px;">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="panel-heading" style="background-color: #28a9da;"><h4>创建新项目</h4></div>
                        <div class="panel-body">
                        <form method="post"  action="/project/add/post"  enctype="multipart/form-data" >
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="exampleInputimage">封面上传</label>
                            ...
                            <input type="submit" class="btn btn-default" style="background-color:#28a9da;color:white" value="创建">
                        </form>
