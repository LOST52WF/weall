            ...
            <!---------------------------热门项目--------------------------->
                ...
                <div class="row" style="margin-bottom: 30px;">
                    <div class="col-md-10 col-md-offset-2" style="margin-right:-83px;">
                        ...
                        <div class="col-md-2" style="width:190px;margin-left:0px;padding-left:0px;padding-right: 25px;">
                            <div class="thumbnail" style="height:170px;">
                                <img src="/static/img/{{$i%8}}.ico" alt="图片" style="height:80px;width:80px;">
                                <p style="margin-top:6px;" class="p-title">
                                    <b style="font-weight:500;">{{$v->title}}</b>
                                </p>
                                <p style="color: grey;font-size:13px;margin-bottom:0px;">
                                    点击量：<span class="glyphicon glyphicon-expand" aria-hidden="true"></span>
                                    {{$v->click}}
                                </p>
                                <p style="color: grey;font-size:13px;">
                                    上传时间：<span class="fa fa-calendar-o" aria-hidden="true"></span>
